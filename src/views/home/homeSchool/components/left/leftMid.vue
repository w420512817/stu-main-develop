<template>
  <div class="mt-10px">
    <div>
      <span class="tit2">各年级{{ params.scTypeName }}</span>
    </div>
...
import { classYearAbnormalRate } from '@/api/dashbord/school';
...
async function getClassYearAbnormalRate() {
  let res = await classYearAbnormalRate(params);
  dataList.value = res;
  setLine();
}
