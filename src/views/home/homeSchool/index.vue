    ...
    <n-gi>
      ...
      <div class="card mt-4">
        <div class="flex justify-between items-center mb-15px">
          ...
          <!-- <n-button class="text-[#777] text-14px" text>
            查看更多 <icon-material-symbols:arrow-forward-ios-rounded />
          </n-button> -->
        </div>
        <rightBottom />
      </div>
...
import { baseInfo, overView, getScreeningTypeList } from '@/api/dashbord/school';
...
const overViewList = reactive([
  ...
  { name: '教师总数', v: 0, key: 'teacherCount' },
  { name: '年级总数', v: 0, key: 'gradeCount' },
  { name: '班级总数', v: 0, key: 'classCount' },
  { name: '教室总数', v: 0, key: 'classroomCount' }
]);
