<template>
  ...
  <div class="expand-all relative">
    ...
    <!-- <div class="absolute top-13% left-12% flex-col justify-evenly h-84%">
...
import { getCariesPrefxScreenData } from '@/api/bigScreen/cavity';
...
async function getData() {
  try {
    loadingFn(1);
    const res = await getCariesPrefxScreenData({ planId: params.planId, id: params.id, level: params.level });

    // console.log('left-bottom', res);

    opts.yAxis.data = res.map(i => i.prefxName);
